...
#	endif
    ...
    mat<3, 4, T, Q>::mat(mat<3, 4, T, P> const &m)
...
#		endif
    ...
    mat<3, 4, T, Q>::mat(mat<3, 4, U, P> const &m)
#		if GLM_HAS_INITIALIZER_LISTS
    : value{col_type(m[0]), col_type(m[1]), col_type(m[2])}
#		endif
    {
...
#		endif
    ...
    mat<3, 4, T, Q>::mat(mat<2, 2, T, Q> const &m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
    ...
    mat<3, 4, T, Q>::mat(mat<3, 3, T, Q> const &m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
    ...
    mat<3, 4, T, Q>::mat(mat<4, 4, T, Q> const &m)
#		if GLM_HAS_INITIALIZER_LISTS
    : value{col_type(m[0]), col_type(m[1]), col_type(m[2])}
#		endif
    {
...
#		endif
    ...
    mat<3, 4, T, Q>::mat(mat<2, 3, T, Q> const &m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
    ...
    mat<3, 4, T, Q>::mat(mat<3, 2, T, Q> const &m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
    ...
    mat<3, 4, T, Q>::mat(mat<2, 4, T, Q> const &m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
    ...
    mat<3, 4, T, Q>::mat(mat<4, 2, T, Q> const &m)
#		if GLM_HAS_INITIALIZER_LISTS
    : value{col_type(m[0], 0, 0), col_type(m[1], 0, 0), col_type(m[2], 1, 0)}
#		endif
    {
...
#		endif
    ...
    mat<3, 4, T, Q>::mat(mat<4, 3, T, Q> const &m)
#		if GLM_HAS_INITIALIZER_LISTS
    : value{col_type(m[0], 0), col_type(m[1], 0), col_type(m[2], 0)}
#		endif
    {
...
#		endif
    ...
    typename mat<3, 4, T, Q>::col_type const &
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER typename mat<3, 4, T, Q>::row_type
